...
app.get('/fiche_client',(req,res)=>{
    showClient((err,data)=>{
        if (err){
            ...
            res.render('fiche_client',{ users : data })
        }
    })
})
app.post('/fiche_client/submit',(req,res)=>{
...
app.get('/fiche_personnel',(req,res)=>{
    showPersonnel((err,data)=>{
        ...
        else{res.render('fiche_personnel',{users :data})}
    })
})
app.post('/fiche_personnel/submit', (req, res) => {
